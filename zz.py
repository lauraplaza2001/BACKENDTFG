...
def generarResultados(idEjercicio : str, videoFrontal : str, videoPerfil: str, emailUsuario : str) :
   ...
   # os.remove("informe.pdf")
    ...
    url = "https://5c45-34-91-206-19.ngrok-free.app/openPose"
    ...
    for tip in ejercicio['tips'] :
        ...
        if tip == "ANCHURAABIERTOAGARREBARRA" : # frontal
         ...
         #       print(diferenciaDerecha)
            ...
            cota =4 # numero de  vecesque debe cumplirse la extension de cadera 
            ...
            for keypoint in filesPerfil :
                ...
                diferencia= abs(codoIzq_y-hombroIzq_y)
...
#al final del movimiento
            ...
            margen = 15
            contador = int(0.8* keypointsFrontal)
            secumple=0
            limiteVeces=3
...
informeAux = {
        "idUsuario" : "640a08b562c599005ca7070f",
        "emailUsuario" : "lauraaplazaa@gmail.com",
        "idEjercicio" : "640de167afa7834d701b62bf",
        "videoFrontal" : "https://res.cloudinary.com/drcsegsao/video/upload/v1684414839/TFG/frontal_jrfkbm.mp4",
        "videoPerfil" : "https://res.cloudinary.com/drcsegsao/video/upload/v1684414839/TFG/perfil_r7jkp5.mp4"
    }
